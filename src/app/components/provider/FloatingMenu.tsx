    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          {/* Menu Wrapper with padding from screen */}
          <motion.div
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "100%" }}
          ...
          >
            {/* Actual Menu Box */}
            <div className="bg-[#111827] backdrop-blur-2xl border border-white/10 rounded-3xl pt-20 pb-16 flex flex-col items-center shadow-2xl">
              ...
              <button onClick={onClose} className="mt-16">
                <div className="w-24 h-24 rounded-full border border-white/20 flex items-center justify-center">
                  <div className="w-20 h-20 rounded-full bg-red-900 flex items-center justify-center shadow-xl">
  ...
  return (
    <Link href={href}>
      <div
        ...
        } rounded-full bg-white/5 border border-white/10 backdrop-blur-xl flex flex-col items-center justify-center text-[11px] text-white shadow-lg hover:bg-white/10 transition-colors`}
      >
        <Icon
          size={large ? 26 : 20}
